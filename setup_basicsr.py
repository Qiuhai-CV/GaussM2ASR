...
if __name__ == '__main__':
    ...
    setup(
        name='gaussm2asr',
        version=get_version(),
        description='GaussM2ASR: anatomy-guided multi-contrast MRI arbitrary-scale super-resolution',
        long_description=readme(),
        long_description_content_type='text/markdown',
        author='GaussM2ASR Authors',
        keywords='computer vision, restoration, super resolution',
        url='https://github.com/Qiuhai-CV/GaussM2ASR',
