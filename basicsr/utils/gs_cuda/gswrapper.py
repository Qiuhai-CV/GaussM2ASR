...
try:
    from . import gscuda as GSWrapper
except ImportError as error:
    raise ImportError(
        'Unable to import the GaussM2ASR CUDA renderer. Run '
        'python setup_gscuda.py build_ext --inplace from the repository root.') from error
